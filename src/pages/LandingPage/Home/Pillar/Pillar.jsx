		...
		<div className="h-[100vh] px-container pb-[10vh] flex justify-center items-center font-poppins">
			<div className="max-w-[840px] flex flex-col gap-12">
				...
				<div className="flex gap-10">
					<div className="w-72 h-72 hover:h-80 ease-in-out transition-all duration-300 rounded-xl bg-primary text-white flex flex-col justify-between items-center group">
					...
					<div className="w-72 h-72 hover:h-80 ease-in-out transition-all duration-300 rounded-xl bg-secondary text-white flex flex-col justify-between items-center group">
						<div className="m-5 w-5/6 flex flex-col gap-3">
							<h3 className="font-poppins font-semibold text-3xl">
								Growth
							</h3>
					...
					<div className="w-72 h-72 hover:h-80 ease-in-out transition-all duration-300 rounded-xl bg-accent text-white flex flex-col justify-between items-center group">
						<div className="m-5 w-5/6 flex flex-col gap-3">
							<h3 className="font-poppins font-semibold text-3xl">
								Trust
							</h3>
